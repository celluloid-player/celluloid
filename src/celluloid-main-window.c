...
constructed(GObject *object)
{
	...
	adw_overlay_split_view_set_content(ADW_OVERLAY_SPLIT_VIEW(priv->video_split_view), priv->video_area);
	adw_overlay_split_view_set_sidebar(ADW_OVERLAY_SPLIT_VIEW(priv->video_split_view), priv->playlist);
	gtk_widget_add_css_class(gtk_widget_get_parent(adw_overlay_split_view_get_sidebar(ADW_OVERLAY_SPLIT_VIEW(priv->video_split_view))), "osd");
	adw_overlay_split_view_set_sidebar_position(ADW_OVERLAY_SPLIT_VIEW(priv->video_split_view), GTK_PACK_END);
	adw_overlay_split_view_set_show_sidebar(ADW_OVERLAY_SPLIT_VIEW(priv->video_split_view), FALSE);
	adw_overlay_split_view_set_collapsed(ADW_OVERLAY_SPLIT_VIEW(priv->video_split_view), TRUE);
						...
						gboolean visible )
{
	...
	adw_overlay_split_view_set_show_sidebar(ADW_OVERLAY_SPLIT_VIEW(priv->video_split_view), visible);
}

gboolean
celluloid_main_window_get_playlist_visible(CelluloidMainWindow *wnd)
{
	return adw_overlay_split_view_get_show_sidebar(ADW_OVERLAY_SPLIT_VIEW(get_private(wnd)->video_split_view));
}
